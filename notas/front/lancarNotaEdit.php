...
$queryNota = "SELECT 
                ...
                LAN.ID_USUARIO,
                LAN.ID_TIPODESPESA,
                LAN.ID_TIPOPAGAMENTO,
                LAN.ID_PERIODICIDADE,
                LAN.CNPJ,
                LAN.auditoria,
                LAN.obra,
                LAN.relatorio_siscon,
                LAN.motivo_siscon,
                LAN.observacao,
                LAN.numero_nota,
                LAN.serie_nota,
                ...
                LAN.date_create,
                LAN.telefone,
                LAN.carimbar AS carimbo,
                RAT.tipo_serv, 
                RAT.ID_RATEIOFORNECEDOR AS RATEIOFORNECEDOR,BAN.*, 
                LOG.nome AS USUARIO, 
                FORN.nome_fornecedor as NOMEFORNECEDOR, 
                FORN.ID_FORNECEDOR, 
                ...
                $queryValidador = "SELECT tipo_serv FROM cad_lancarnotas WHERE ID_LANCARNOTAS = $idnota";
                $resultValid = $conn->query($queryValidador);
                $tipo_serv = $resultValid->fetch_assoc();
                if(!empty($tipo_serv['tipo_serv'])){
                  $queryNota .= " AND RAT.tipo_serv = LAN.tipo_serv";
                }

              $queryNota .= " LEFT JOIN cad_rateiobanco BAN ON BAN.ID_RATEIOFORNECEDOR = RAT.ID_RATEIOFORNECEDOR
...
<body id="page-top">
      ...
      <div id="content">
        ...
        <div class="container-fluid">
          ...
          <div class="d-sm-flex align-items-center justify-content-between mb-4">
            <h1 class="h3 mb-0 text-gray-800">Nota <?php echo $idnota; ?></h1>
          </div>
                ...
                <div class="card-body">
                  ...
                  <div class="form-row">
                    <div class="col">
                      ...
                      <input type="text" class="form-control" value="<?php echo $row['USUARIO']; ?>" id="userLanc">
                      ...
                      <input type="text" class="form-control" name="tipo_serv" id="tipo_serv" value="<?php echo $row['tipo_serv']; ?>">

                    </div>
                    <div class="col">
                      <label for="fornecedor">Fornecedor</label>
                      <input type="text" class="form-control" id="fornecedor" value="<?php echo $row['NOMEFORNECEDOR']; ?>" maxlength="18">
                      ...
                      <input type="hidden" class="form-control" id="idrateiofornecedor" value="<?php echo $row['RATEIOFORNECEDOR']; ?>">
                    </div>
                    <div class="col">
                      <label for="txtFilialNota">Filial</label>
                      <input type="text" class="form-control" name="txtFilialNota" id="txtFilialNota" value="<?php echo $row['NOMEFILIAL']; ?>" required>
                      <input type="hidden" class="form-control" name="filialNota" id="filialNota" value="<?php echo $row['ID_FILIAL']; ?>">
                    </div>
                  </div>
                </div>
              </div>
                ...
                <div class="card-body">
                  <div class="form-row">
                    <div class="col">
                      ...
                      <input type="text" class="form-control" id="numeroNotaEdit" value="<?php echo $row['numero_nota']; ?>">
                      <br>
                      <label for="serieNotaEdit">Série</label>
                      <input type="text" class="form-control" id="serieNotaEdit" value="<?php echo $row['serie_nota']; ?>">
                    ...
                    <div class="col">
                      ...
                      <input type="date" class="form-control" id="emissaoNotaEdit" value="<?php echo $emissaoNota; ?>">
                      <br>
                      <label for="vencNotaEdit">Vencimento</label>
                      <input type="date" class="form-control" id="vencNotaEdit" value="<?php echo $vencNota; ?>">
                      <br>
                      <label for="valorNotaEdit">Valor</label>
                      <input type="text" class="form-control" id="valorNotaEdit" onkeyup="formatarMoeda()" value="<?php echo $row['valor_nota']; ?>">
                ...
                <div class="card-body">
                  ...
                  <div class="form-row">
                    <div class="col">
                      ...
                      <div id="dep" style="display: <?php echo $checktipopgto; ?>;">
                        ...
                        <div class="form-group">
                          ...
                          <input type="text" class="form-control" name="txtBanco" value="<?php echo $rowB['nome_banco']; ?>" id="txtBanco">
                          <input type="hidden" class="form-control" name="banco" value="<?php echo $rowB['nome_banco']; ?>" id="banco">
                        </div>

                        <div class="form-group">
                          <label for="agEdit">Agência</label>
                          <input type="text" class="form-control" id="agEdit" value="<?php echo $rowB['agencia']; ?>">
                        </div>

                        <div class="form-group">
                          <label for="contaEdit">Conta</label>
                          <input type="text" class="form-control" id="contaEdit" value="<?php echo $rowB['conta']; ?>">
                        </div>

                        <div class="form-group">
                          <label for="digitoEdit">Dígito</label>
                          <input type="text" class="form-control" id="digitoEdit" value="<?php echo $rowB['digito']; ?>">
                        </div>
                    ...
                    <div class="col">
                      ...
                      <textarea class="form-control" rows="3" id="obsEdit"><?php echo $row['observacao']; ?></textarea>
                      <br>
                      ...
                      <div id="cons" style="display: <?php echo $checkconsorcio; ?>;">
                        ...
                        <div class="form-group">
                          ...
                          <input type="text" class="form-control" id="motivoSisconEdit" value="<?php echo $row['motivo_siscon']; ?>">
                          <small class="form-text text-muted">Apenas se for do consórcio.</small>
                        </div>
  ...
  <script type="text/javascript">
    $('input[name=nfDptoAudiEdit][value=' + <?php echo $row['auditoria']; ?> + ']').prop('checked', true);
    $('input[name=nfObrasEdit][value=' + <?php echo $row['obra']; ?> + ']').prop('checked', true);
    $('input[name=relSisconEdit][value=' + <?php echo $row['relatorio_siscon']; ?> + ']').prop('checked', true);
