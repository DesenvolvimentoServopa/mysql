...
<body>
                ...
                <div class="card">
                    <div class="card-body overflow-hidden p-lg-6">
                        ...
                        <ol class="breadcrumb">
                            ...
                            <li><i class="fa fa-comments"></i> Nova postagem</li>
                        </ol><br>
                        <div class="card">
                            <div class="card-body">
                                <form class="form-validate form-horizontal" id="feedback_form" method="POST"
                                    ...
                                    <div class="form-group" style="display: none;" id="dataDiv">
                                        <label for="agree" class="control-label col-lg-2 col-sm-3">Inativar
                                            postagem:</label>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <br>
                                        <select class="form-control m-bot15 fimDate" id="dataFim"
    ...
    $(document).ready(function() {
        ...
        $("#ramal_row").click(function() {
            $('#addrR' + i).html("<label for='agree' class='control-label col-lg-2 col-sm-3'>" + (i +
                1) + ":</label><input type='file' class='form-control-file' id='file' name='file" +
                i + "'>");
