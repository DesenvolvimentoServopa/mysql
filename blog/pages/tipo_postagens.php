                ...
                <div class="card">
                    <div class="card-body overflow-hidden p-lg-6">
                        <div class="row align-items-center">
                            ...
                            <div>
                                <h4 class="mb-1">Nova postagem &emsp;<img src="icons/desktop-computer.png" width="5%">
                                </h4>
                            </div>
                            <ol class="breadcrumb">
                    ...
                    <div class="row">
                            ...
                            <div class="card">
                                <div class="card-body">
                                    &emsp;<a href="nova_publicacao.php?pagina=4" class="publicacao">
                                        <img src="img/imagem.svg" alt="" id="caroselOne" width="65%">
                                        <p class="titulo_carrosel ">Apenas uma imagem em uma
                                            publicação
                                        </p>
                                    </a>
                                </div>
                        ...
                        <div class="col">
                            <a href="nova_publicacao_carousel.php?pagina=6" class="publicacao">
                                <div class="card">
                                    <div class="card-body">
                                        <img src="img/imagens.svg" alt="" id="carosel" width="65%">
                                        <p class="titulo_carrosel ">Várias imagens em uma
                                            publicação</p>
                                    </div>
                                </div><br>
                            </a>
