...
$post_query = "SELECT titulo, mensagem FROM blog_post WHERE id_postagem = ".$_GET['id_post']."";
  $result_post = $conn->query($post_query);
                    ...
                    <div class="card-body">
                        <div class="card-body overflow-hidden p-lg-6">
                            <div class="row align-items-center">
                                ...
                                <div>
                                    <h4 class="mb-1">Postagem sendo editada <i class="far fa-comment-dots"></i></h4>

                                </div>
                            </div>
                            <ol class="breadcrumb">
                                <li><i class="fa fa-home"></i><a href="dashboard.php?pagina=1">Home / </a></li>
                                <li><i style="margin-left: 10px" class="fa fa-comments"></i> Editando</li>
                            </ol>
                            <br>
                            <br>
                            <div class="card">
                                <div class="card-body">
                                    <form role="form" method="POST" action="editar.php" enctype="multipart/form-data">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input name="titulo" type="text" class="form-control" style="width: 81%;"
                                                id="exampleInputEmail1" value="<?= $post['titulo'] ?>">
                                        </div>
                                        <div class="form-group">
                                            <label for="exampleInputEmail1">Deseja usar a mesma imagem / video
                                                ?</label><br />
                                            ...
                                            <label class="label_radio r_on" for="radio-02">
                                                <input name="arquivo" id="radio-02" value="0" type="radio"
                                        ...
                                        <div class="form-group">
                                            <div class="col-sm-12">
                                                ...
                                                <textarea name="mensagem"
                                                    style="width: 100%;"><?= $post['mensagem'] ?></textarea>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <div class="col-sm-10" style="margin-top: 20px; margin-right: -16px;">
