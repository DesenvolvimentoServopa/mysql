...
$result_comentario = $conn->query($query_comentario);
            ...
            <nav class="navbar navbar-light navbar-vertical navbar-expand-xl">
                ...
                <div class="d-flex align-items-center">
                    <div class="toggle-icon-wrapper">
                        ...
                        <div class="d-flex align-items-center py-3"><span style="margin-right:50px" class="font-sans-serif">BLOG ADMIN</span>
                        </div>
                    </a>
                </div>
                    ...
                    <ul class="navbar-nav navbar-nav-icons ms-auto flex-row align-items-center">
                        ...
                        <li class="nav-item">
                            <a class="nav-link px-0 notification-indicator notification-indicator-warning notification-indicator-fill fa-icon-wait"
                                href="postagens.php?pagina=2">&emsp;&emsp;<span class="fas fa-bell" data-fa-transform="shrink-7"
                                    style="font-size: 33px;"></span><span
                                    class="notification-indicator-number"><?= $_SESSION['posts']; ?></span></a>

                        </li>
                        
                        &emsp;&emsp; <li class="nav-item dropdown"><a class="nav-link pe-0" id="navbarDropdownUser" href="#"
                  ...
                  <div class="card-body">
                    <div class="card-body overflow-hidden p-lg-6">
                        <div class="row align-items-center">
                            ...
                            <div>
                                <h4 class="mb-1">Comentários <i class="far fa-comment-dots"></i></h4>
                                
                            </div>
                        </div>
                        <ol class="breadcrumb">
                            <li><i class="fa fa-home"></i><a href="dashboard.php?pagina=1">Home</a> / </li>
                            <span style="margin-left:10px"><li><i class="fa fa-comments"></i> Comentários</span></li>
                        </ol>
                        <br>
                        <br>
                        <?php
                                    ...
                                    while($post_geral = $result_post->fetch_assoc()){
                                        $_SESSION['posts'] = $post_geral['posts'];}

                                    while($comentario_geral = $result_comentario->fetch_assoc()){
                                        $_SESSION['contagem'] = $comentario_geral['contagem'];
                                    ...
                                    <div class='panel-group m-bot20' id='accordion'>
                                        <div class='panel panel-default'>
                                            <div class='panel-heading'>
                                                <h5 class='card'>
                                                    <div class='card-body'>
                                                        <a class='accordion-toggle' data-bs-toggle='collapse' data-parent='#accordion' href='#collapse".$add."'>
                                                            ".$comentario_geral['titulo']." - <span style = 'color:red;'>".$comentario_geral['contagem']." comentários não resolvidos</span>
                                                        </a>
                                                    </div>
                                                </h5>
                                            </div>
                                            <div id='collapse".$add."' class='panel-collapse collapse in' style='height: 0px;'>
                                                <div class='panel-body'>";    
                                                    ...
                                                    WHERE 
                                                        ...
                                                        $resultado = $conn->query($query_detalhesComentario);
                                                        ...
                                                        while($comentario = $resultado->fetch_assoc()){
                                                            ...
                                                            <div class='panel panel-info'>
                                                                <div class='panel-heading'>
                                                                    <div class='panel-body'>
                                                                        <div class='alert alert-info' role='alert'><span class='colaborador'>".$comentario['colaborador']."</span> <span class='departamento'>".$comentario['departamento']." - ".$comentario['empresa']."</span>
                                                                        <span class='acao'>
                                                                        <a href='alter_comentario.php?avisa=".$comentario['id_comentario']."' class='acaoComentario' title='Marcar como resolvido'>
                                                                                    <i class='far fa-check-circle' style = 'margin-left:10px;float: right;'></i>
                                                                                </a> 
                                                                        ...
                                                                        </div>".$comentario['comentario']."<div class='dropdown-divider'></div></div>";
                                                                    }
                                                    echo "    
                                                                    </div>
                                                                </div>
