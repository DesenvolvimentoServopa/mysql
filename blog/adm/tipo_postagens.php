        ...
        <div class="container" data-layout="container">
            ...
            <nav class="navbar navbar-light navbar-vertical navbar-expand-xl">
                ...
                <div class="d-flex align-items-center">
                    ...
                    </div><a class="navbar-brand" href="dashboard.php?pagina=1">
                ...
                <div class="card">
                    <div class="card-body overflow-hidden p-lg-6">
                        <div class="row align-items-center">
                            ...
                            <div>
                                <h4 class="mb-1">Nova postagem <i class="far fa-paper-plane"></i>
                                </h4>
                            </div>
                            <ol class="breadcrumb">
                                <li><i class="fa fa-home"></i><a href="dashboard.php?pagina=1">Home</a></li> /
                                <li><span style="margin-left:10px"><i class="fa fa-plus-square"></i>Nova postagem</span></li> 
                            </ol>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col">
                            <div class="card">
                                <div class="card-body">
                                    &emsp;<a href="nova_publicacao.php?pagina=4" class="publicacao">
                                        <img src="img/imagem.svg" alt="" id="caroselOne" style="margin-left:50px" width="65%">
                                        <p class="titulo_carrosel" style="text-align:center">Uma imagem em uma
                                            publicação
                                        </p>
                                    </a>
                                </div>
                        ...
                        <div class="col">
                            <a href="nova_publicacao_carousel.php?pagina=6" class="publicacao">
                                <div class="card">
                                    <div class="card-body" >
                                        <img src="img/imagens.svg" alt="" id="carosel" style="margin-left:70px" width="65%">
                                        <p class="titulo_carrosel"  style="text-align:center">Várias imagens em uma publicação</p>
                                    </div>
                                </div><br>
                            </a>
                        </div>
