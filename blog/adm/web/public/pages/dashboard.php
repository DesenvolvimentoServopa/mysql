                ...
                <div class="card">
                    <div class="card-body">
                        <div class="row align-items-center">
                            ...
                            <div>
                                <h4 class="mb-1">Minhas postagens <img src="icons/book.png" width="5%">
                                </h4>
                                <a href="tipo_postagens.php?pagina=5" style="float:right;"> <button type="button"
                                        class="btn btn-small btn-primary">Nova
                                        postagem</button>
                                </a><br>
                            </div>
                            <br>
                                        ...
                                        <tbody class="list">
                                            <?php 
                                                                while ( $row = $result->fetch_assoc() ){
                                                                    ...
                                                                    if($row['carousel'] == 1){
                                                                        echo "<td><a href='#arquivo".$row['id_postagem']."' data-bs-toggle='modal' title='Clique para ver o arquivo'>Arquivo</a></td>"; 
                                                                      }
                                                                    else{
                                                                        echo "<td><a href='../".$row['file_img']."' target='_blank' title='Clique para ver o arquivo'>Arquivo</a></td>";
                                                                      ...
                                                                      echo "<td><a href='../".$row['mensagem']."'  data-bs-toggle='modal' data-bs-target='#modalmsg'>Mensagem</a></td>
                                                          ...
                                                          echo "
                                                        <div class='modal fade' id='arquivo".$row['id_postagem']."' tabindex='-1' role='dialog' aria-hidden='true'>
                                                        <div class='modal-dialog modal-dialog-centered' role='document' style='max-width: 500px'>
                                                          <div class='modal-content position-relative'>
                                                            <div class='position-absolute top-0 end-0 mt-2 me-2 z-index-1'>
                                                              <button class='btn-close btn btn-sm btn-circle d-flex flex-center transition-base' data-bs-dismiss='modal' aria-label='Close'></button>
                                                            ...
                                                            <div class='modal-body p-0'>
                                                              <div class='rounded-top-lg py-3 ps-4 pe-6 bg-light'>
                                                                <h5 class='mb-1' id='modalExampleDemoLabel'>Mensagem da Publicação - ".$row['titulo']."</h5>
                                                              </div>
                                                              <div class='p-4 pb-0'>
