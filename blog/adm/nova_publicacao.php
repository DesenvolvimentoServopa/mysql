...
<body>
            ...
            <div class="content">
                <nav class="navbar navbar-light navbar-glass navbar-top navbar-expand">
                    ...
                    <ul style="margin-right:15px"
                        ...
                        <li style="margin-right:50px" class="nav-item dropdown"><a class="nav-link pe-0"
                ...
                <div class="card">
                    <div class="card-body overflow-hidden p-lg-6">
                        ...
                        <ol class="breadcrumb">
                            ...
                            <li><i style="margin-left: 10px;" class="fa fa-comments"></i> Nova postagem</li>
                        </ol><br>
                        <div class="card">
                            <div class="card-body">
                                <form class="form-validate form-horizontal" id="feedback_form" method="POST"
                                    action="salvar_postagem.php?pagina=4" enctype="multipart/form-data"
                                    autocomplete="off">
                                    ...
                                    <br>
                                    <div class="form-group">
                                        <label for="agree" class="control-label col-lg-2 col-sm-3">Tipo da
                                            postagem:</label>
                                    ...
                                    <div class="form-group" style="display: none;" id="dataDiv" >
                                        ...
                                        <input style="width:200px" type="date"
                                            class="form-control date col-sm-3 inativarDate" id="datepicker"
                                            name="dataFim" placeholder="DD / MM / AAAA" > <span class="glyphicon glyphicon-th"></span>
                                    </div>
                                    <br>
                                    <div class="form-group">
                                        <label for="agree" style="width:200px" class="control-label col-lg-2 col-sm-3"
                                    ...
                                    <br>
                                    <div class="form-group">
                                        <label for="agree" class="control-label">Imagem /
                                            Video:</label>
    ...
    <!--MOSTRAR E ESCONDER-->
    <script>
        var b = document.querySelector("#datepicker");
    ...
    <script src="flatpickr/dist/l10n/pt.js"></script>
