...
?>
                            ...
                            <div class="col-auto">
                                <h6 class="mb-0">
                                    <ul class="breadcrumb notop">
                                        ...
                                        <li class="active">
                                            <i class="icon-hand-right"></i><?php echo $_POST['pesquisar'];?>
                                            Pesquisa
                                        </li>
                                    </ul>
                                </h6>
            ...
            <div class="card" style="box-shadow:  8px 8px 50px 20px #b0b0b0,
  ...
  $limite = $banco_blog->query("$busca LIMIT $inicio, $total_reg");

	$todos = $banco_blog->query($busca);
  $result = $todos->fetch_assoc();
	 
	$tr = mysqli_num_rows($todos); // verifica o número total de registros
	$tp = $tr / $total_reg; // verifica o número total de páginas
	 
$resultado_pesquisa = $_POST['pesquisar'];
if ($result == null ) { // se o campo não encontrar o resultado no banco retorna a msg 
  echo "<h1 style='text-align: center;'>Não encontramos resultado para sua pesquisa</h1>
  <img style='margin-left:300px' src='img/research-paper-animate.svg' width='40%'>";
}else{
    ...
    $result = $banco_blog->query($comentario); 
        ...
        <div class="fs--1 mt-4 mb-3">
            <div class="col-12 col-sm-auto text-center">
                <p style="text-align: center;">&copy; Departamento T.I - Todos os direitos reservados<span
                        class="d-none d-sm-inline-block"> | </span><br class="d-sm-none" /> 2023 Desenvolvido por <a
