...
//permissão
$queryEquipamento .= " WHERE MIE.deletar = 0 AND MIE.tipo_equipamento IN (";
...
<div class="container-fluid">
  ...
  <h1 class="text-xs mb-6 text-gray-800">
    ...
    <i class="fas fa-laptop"></i> Todos Equipamentos
  </h1>
  <hr />
  ...
  <div class="card shadow mb-4">
    <div class="card-header py-3">
      <h6 class="m-0 font-weight-bold text-<?= $_SESSION["colorHeader"] ?>">
        ...
        <a href="equipamentosall.php?pagina=5" class="float-right" title="Todos">
            ...
            while ($equipamento = $result->fetch_assoc()) {
              ...
              if ($_SESSION['perfil'] == 1) { //USUÁRIO
                ...
                if (isset($equipamento['id_funcionario'])) {
                  echo '<a href="../inc/pesquisaFuncionario.php?id=' . $equipamento['id_funcionario'] . '" class="text-info menu rigtIcones" title="' . $equipamento['nome'] . '"><i class="fas fa-user"></i></a>
